function create() {
  ...
  // - A random room to be designated as the end room (with the stairs and nothing else)
  ...
  // Phaser support multiple cameras, but you can access the default camera like this:
